...
exports.bodyAuthRequired = void 0;
...
var authRequired = function (model) {
...
var bodyAuthRequired = function (model) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var token, decoded, user, err_2;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    token = (_a = req.body.Authorization) === null || _a === void 0 ? void 0 : _a.replace("Bearer ", "");
                    decoded = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET);
...
exports.bodyAuthRequired = bodyAuthRequired;
